...
if re.search('^(([A-Я][а-я]+ [A-Я][а-я]+)|([A-Z][a-z]+ [A-Z][a-z]+))$', name) is None:
    print('Неверный формат имени и фамилии')
...
if re.search('[\.]{2,}', some_str):
    print('Есть более одной точки подряд')
else:
    print('Нет более одной точки подряд')