        ...
        try:
            ...
            if count > 0:
                if round(count * 100) == count * 100:
                    ...
                    print('Дробное число копеек недопустимо')
            else:
                print('Введите положительное число')
        except ValueError:
            print('Укажите сумму к снятию в виде числа')
...
def start():
    try:
        ...
        print('Номер карты и пин код необходимо указывать через пробел')
        return
    ...
    try:
        ...
        print('Номер карты и пин код должны быть числовыми значениями')
        return
